...
local GEAR_KEYWORDS = {
    ...
    "pot","planter","gear","tool","recall","growth","mutant","auto","harvester",
    "sturdy","radiant","golden","emerald","ruby","void","basic","advanced","pro",
}
local SEED_KEYWORDS = {
...
local function guessCategory(name)
    local n = name:lower()
    -- Prioritize direct seed/gear mentions
